...
public class UsuarioService {
    ...
    public UsuarioSummaryDTO buscarUsuarioPorId(Long id, Long usuarioLogadoId) {
        ...
        UsuarioSummaryDTO dto = converterParaUsuarioSummaryDTO(usuario, usuarioLogadoId, seguindoUsuario);
        return dto;
    }
    ...
    public UsuarioResponseDTO buscarUsuarioPorUsername(String username, Long usuarioLogadoId) {
        ...
        UsuarioResponseDTO dto = converterParaUsuarioResponseDTO(usuario, usuarioLogadoId, seguindoUsuario);
        return dto;
    }
    ...
    private UsuarioResponseDTO converterParaUsuarioResponseDTO(Usuario usuario, Long usuarioLogadoId) {
        return converterParaUsuarioResponseDTO(usuario, usuarioLogadoId, null);
    }

    private UsuarioResponseDTO converterParaUsuarioResponseDTO(Usuario usuario, Long usuarioLogadoId, Boolean seguindoUsuario) {
    ...
    private UsuarioSummaryDTO converterParaUsuarioSummaryDTO(Usuario usuario, Long usuarioLogadoId) {
        return converterParaUsuarioSummaryDTO(usuario, usuarioLogadoId, null);
    }

    private UsuarioSummaryDTO converterParaUsuarioSummaryDTO(Usuario usuario, Long usuarioLogadoId, Boolean seguindoUsuario) {
